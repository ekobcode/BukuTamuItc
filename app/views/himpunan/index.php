          ...
          <table class="table table-bordered">
                  ...
                  <?php $no=1; ?> 
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url; ?>/himpunan/edit/<?= $row['id'] ?>" class="badge badge-info ">Edit</a> <a href="<?= base_url; ?>/himpunan/hapus/<?= $row['id'] ?>" class="badge badge-danger" onclick="return confirm('Hapus data?');">Hapus</a>
                      </td>
                    </tr>
                    <?php $no++; endforeach; ?>
                  </tbody>
